...
import SmardoveMailSecurity from './components/SmardoveMailSecurity.vue'
import FeatureSection from './components/FeatureSection.vue'
import SmardoveInfoGraphic from './components/SmardInforgraphic.vue'
import InspiringHero from './components/InspiringHero.vue'
import ConnectWorld from './components/ConnectWorld.vue'
import OverviewProduct from './components/OverviewProduct.vue'
import SmartdoveCommunity from './components/SmartdoveCommunity.vue'
